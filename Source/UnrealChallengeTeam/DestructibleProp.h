...
UCLASS()
class UNREALCHALLENGETEAM_API ADestructibleProp : public AActor
{
	GENERATED_BODY()
...
public:	
	...
	UFUNCTION()
	void Trigger(UPrimitiveComponent* HitComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult &SweepResult);
	UFUNCTION()
